...
int main() {
    ...
    SuperPoder1 = (float)populacao1 + area1 + pib1 + (float)pontos_turisticos1 + Pibporcapital1 + ( 1 / desidadePopulacional1);
    ...
    SuperPoder2 = (float)populacao2 + area2 + pib2 + (float)pontos_turisticos2 + Pibporcapital2 + ( 1 / desidadePopulacional2);
    ...
    printf("o pib por capital e: %f\n", Pibporcapital2);
    printf("o super poder e: %.2f", SuperPoder2);

    //coparacao das cartas
